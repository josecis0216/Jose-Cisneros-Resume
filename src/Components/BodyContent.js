        ...
        return (
            <div>
                <div className="containerStyles"id="home">
                    <div className="containerStylesHeadshot">
                        <div className="col-lg-8" style={{padding: 20+'px'}}>
                        ...
                        <div className="col-lg-4">
                        <img src={headshot} className="card" alt="logo" style={{marginTop: 10+'px', width: 100+'%'}}/>
                        </div>
                    </div>
                </div>
                ...
                <div className="containerStyles">
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-sm-12">
                            <p className="pStyles">
                                <span className="checkMark">&#10004; </span><span className="ulStyles">Peace of mind</span> -- My passion is to meet deadlines and
                        ...
                        <div className="col-lg-3 col-sm-12">
                            <p className="pStyles">
                            <span className="checkMark">&#10004; </span><span className="ulStyles">More time for your loved activites</span> -- I am already familiar with 
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-sm-12">
                            <p className="pStyles">
                            <span className="checkMark">&#10004; </span><span className="ulStyles">A boost in revenue</span> -- I'm acutely aware of the need for excellence in output
                                and client satisfaction, and that leads to client retention and spontaneous referrals for your company.
                            </p>
                        </div>
                        <div className="col-lg-3 col-sm-12">
                            <p className="pStyles">
                            <span className="checkMark">&#10004; </span><span className="ulStyles">Maximize efficiency</span> -- My time organization will bring effeciency
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-sm-12">
                            <p className="pStyles">
                            <span className="checkMark">&#10004; </span><span className="ulStyles">Increase in productivity</span> -- With my experience, I can bring a different work ethic that will stand 
                            out and show results necessary for the development team.
                            </p>
                        </div>
                        <div className="col-lg-3 col-sm-12"></div>
                        <div className="col-lg-3 col-sm-12"></div>
